...
export default function AdminProtocolsPage() {
  ...
  const [categoryToDelete, setCategoryToDelete] = useState<ProtocolCategory | null>(null);
  ...
  const handleAddCategory = async () => {
    ...
    try {
      await ProtocolController.adminCreateProtocolCategory(newCategoryName.trim(), newCategorySlug.trim());
